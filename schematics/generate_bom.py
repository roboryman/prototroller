...
"""
    ...
    Sorted By: Ref
    Fields: Ref, Qnty, Value, Cmp name, Footprint, Description, Vendor, Manufacturer, Manufacturer Part Number
...
out.writerow(['Ref', 'Qnty', 'Value', 'Cmp name', 'Footprint', 'Description', 'Vendor', 'Manufacturer', 'Manufacturer Part Number'])
